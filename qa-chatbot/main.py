...
async def handle_chat_start():
    # Send welcome message to user with an emoji
...
async def handle_message(message: cl.Message):
    ...
    # Send a "thinking" message with an emoji
    ...
    # Send response back to user with an emoji
    await cl.Message(content=f"Here's my answer: \n\n{response_text} 🤖").send()
